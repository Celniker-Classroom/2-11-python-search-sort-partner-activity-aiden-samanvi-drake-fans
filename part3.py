...
userInput = int(input("Choose a number to search for: "))
...
print("Searching for number:", userInput)
...
if userInput in ranNums:
    print("Number",userInput,"found in the list after", comparisons, "comparisons!")
else:
    print("Number",userInput,"not found in the list after", comparisons, "comparisons!")